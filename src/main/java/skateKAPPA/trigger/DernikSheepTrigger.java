...
public class DernikSheepTrigger extends BaseTrigger<DernikSheepTrigger.Instance> {
    
    public static final ResourceLocation ID = new ResourceLocation(SkateKAPPA.MODID, "dernik_sheep");
