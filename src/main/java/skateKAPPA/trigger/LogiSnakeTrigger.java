...
public class LogiSnakeTrigger extends BaseTrigger<LogiSnakeTrigger.Instance> {
    
    public static final ResourceLocation ID = new ResourceLocation(SkateKAPPA.MODID, "logisnake");
